...
create table sendmoneycreator_user(
    ...
    `is` varchar(50) default 0,
    `paypal_payment_url` varchar(50) default 0,
    `isDev` int(1) default 0,
	PRIMARY KEY(user_id,isDev)
);

UPDATE sendmoneycreator_user SET isDev = '1' WHERE user_id = 'hihi';

DELETE FROM sendmoneycreator_user where user_id = '';

select * From sendmoneycreator_user;
select tag From sendmoneycreator_user where user_id = 'hihi';

select user_id, salt, user_password From sendmoneycreator_user where user_id = 'hihi';
select user_id From sendmoneycreator_user where user_id = 'hihi';
...
insert into sendmoneycreator_user(user_id,user_password,user_email,salt,short_description,create_account_time,tag,kakao_payment_url) values('khjcide','1234','anojds@gmail.com','1','개발자','2022-01-01',1,'www.anojds.com');
insert into sendmoneycreator_user(user_id,user_password,user_email,salt,short_description,create_account_time,tag,kakao_payment_url,toss_payment_url,paypal_payment_url) values('hihi','1234','anojds@gmail.com','1','개발자','2022-01-01',1,'https://qr.kakaopay.com/FMkgMcV1I','toss.me/anojds','playpal.me/anojds');
...
UPDATE sendmoneycreator_user SET kakao_payment_url = 'https://qr.kakaopay.com/FMkgMcV1I' WHERE user_id = 'hihi';